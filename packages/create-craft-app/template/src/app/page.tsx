      ...
      <main className="flex-1">
        <section className="container flex flex-col items-center justify-center gap-6 pt-16 pb-8 md:pt-24 lg:pt-32">
          <div className="flex max-w-245 flex-col items-center gap-4 text-center">
            ...
            <p className="text-muted-foreground max-w-175 text-lg md:text-xl">
              An opinionated Next.js boilerplate with everything you need to ship AI-powered SaaS
              products. Authentication, payments, AI chat, and more — all wired up and ready to go.
            </p>
          </div>
        ...
        <section className="container py-16 md:py-24">
          <div className="mb-12 text-center">
            ...
            <p className="text-muted-foreground mt-4 text-lg">
              Stop reinventing the wheel. Start with production-ready infrastructure.
            </p>
          </div>
        ...
        <section className="container py-16 md:py-24">
          <div className="flex flex-col items-center gap-6 text-center">
            <h2 className="text-3xl font-bold tracking-tight md:text-4xl">Ready to Ship?</h2>
            <p className="text-muted-foreground max-w-150 text-lg">
              Clone the repo, set up your environment variables, and start building your next
              AI-powered product in minutes.
            </p>
            <Button size="lg" asChild>
              <Link href="/register">
